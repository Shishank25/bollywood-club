...
const CAREERS_SLOTS = [
  { id: 'hero-video', label: '🎬 Hero Video', description: 'Main background video at the top of the careers page', folder: 'careers' },
  { id: 'role-1', label: '✨ Promoters Card', description: 'Media for the Promoters role card', folder: 'careers' },
  { id: 'role-2', label: '✨ Influencers Card', description: 'Media for the Influencers role card', folder: 'careers' },
  { id: 'role-3', label: '✨ DJs & Artists Card', description: 'Media for the DJs & Artists role card', folder: 'careers' },
  { id: 'role-4', label: '✨ Live Musicians Card', description: 'Media for the Live Musicians role card', folder: 'careers' },
  { id: 'role-5', label: '✨ Vocalists Card', description: 'Media for the Vocalists role card', folder: 'careers' },
  { id: 'form-media', label: '📝 Form Media', description: 'Image or video displayed next to the application form', folder: 'careers' },
];
